defmodule LasagnaTest do
  ...
  @tag task_id: 2
  test "remaining minutes in oven when actual time is negative" do
    assert Lasagna.remaining_minutes_in_oven(-15) === 40
  end

  @tag task_id: 2
  test "remaining minutes in oven when actual time is greater than expected minutes" do
    assert Lasagna.remaining_minutes_in_oven(45) === 0
  end
  ...
  @tag task_id: 3
  test "preparation time in minutes for zero layers" do
    assert Lasagna.preparation_time_in_minutes(0) === 0
  end

  @tag task_id: 3
  test "preparation time in minutes for negative layers" do
    assert Lasagna.preparation_time_in_minutes(-2) === 0
  end
